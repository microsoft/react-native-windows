...
const RNTesterActions = require('@microsoft/react-native/RNTester/js/RNTesterActions');
const RNTesterExampleContainer = require('@microsoft/react-native/RNTester/js/RNTesterExampleContainer');
const RNTesterExampleList = require('@microsoft/react-native/RNTester/js/RNTesterExampleList');
