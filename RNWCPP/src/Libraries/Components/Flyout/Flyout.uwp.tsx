...
export class Flyout extends React.Component<IFlyoutProps, IFlyoutTargetState> {
  ...
  public static getDerivedStateFromProps(nextProps: IFlyoutProps, prevState: IFlyoutTargetState): IFlyoutTargetState {
    ...
    if (prevState.targetRef !== nextProps.target) {
      ...
      const newtarget: number | null = findNodeHandle(
        nextProps.target as null | number | React.Component<IFlyoutProps, IFlyoutTargetState> | React.ComponentClass<Flyout>);
