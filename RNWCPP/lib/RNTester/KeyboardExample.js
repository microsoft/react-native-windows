...
var TabStopExample = /** @class */ (function (_super) {
    ...
    TabStopExample.prototype.render = function () {
        var itemStyle = { width: 120, height: 50, backgroundColor: 'aqua', justifyContent: 'center', alignItems: 'center' };
        ...
        return (React.createElement(react_native_1.View, null,
            ...
            React.createElement(react_native_1.View, { style: { flex: 1, flexDirection: 'row', justifyContent: 'space-between' } },
            ...
            React.createElement(react_native_1.View, { style: { flex: 1, flexDirection: 'row', justifyContent: 'space-between' } },
                React.createElement(index_uwp_1.Picker, __assign({ style: pickerStyle }, { tabIndex: 11 }),
                    React.createElement(index_uwp_1.Picker.Item, { label: "tabIndex 11" })),
                React.createElement(index_uwp_1.Picker, __assign({ style: pickerStyle }, { tabIndex: 13 }),
                    React.createElement(index_uwp_1.Picker.Item, { label: "tabIndex 13" })),
                React.createElement(index_uwp_1.Picker, __assign({ style: pickerStyle }, { tabIndex: 12 }),
                    React.createElement(index_uwp_1.Picker.Item, { label: "tabIndex 12" })))));
    };
