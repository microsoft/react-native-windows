...
var TextExample = /** @class */ (function (_super) {
    ...
    TextExample.prototype.render = function () {
        ...
        return (React.createElement(RNTesterPage, { title: "<Text>" },
    ...
    TextExample.description = 'Base component for rendering styled text.';
    return TextExample;
}(React.Component));
...
exports.default = TextExample;
//# sourceMappingURL=TextExample.uwp.js.map