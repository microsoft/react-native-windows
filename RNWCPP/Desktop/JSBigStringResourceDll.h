...
public:
  ...
  virtual bool isAscii() const override { return false; }

  virtual const char* c_str() const override { return resource; }

  virtual size_t size() const override { return resourceSize - 1; }
