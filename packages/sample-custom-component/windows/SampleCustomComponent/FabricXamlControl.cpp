...
void CustomRegisterXamlControlNativeComponent(
  ...
  packageBuilder.as<winrt::Microsoft::ReactNative::IReactPackageBuilderFabric>().AddViewComponent(
      name, [name, builderCallback](winrt::Microsoft::ReactNative::IReactViewComponentBuilder const &builder) noexcept {
        ...
        if constexpr (&TUserData::FinalizeUpdate != &winrt::SampleCustomComponent::BaseFabricXamlControl<TUserData>::FinalizeUpdate) {
        ...
        if constexpr (
            ...
            &winrt::SampleCustomComponent::BaseFabricXamlControl<TUserData>::UpdateState) {
        ...
        if constexpr (
            ...
            &winrt::SampleCustomComponent::BaseFabricXamlControl<TUserData>::MountChildComponentView) {
        ...
        if constexpr (
            ...
            &winrt::SampleCustomComponent::BaseFabricXamlControl<TUserData>::UnmountChildComponentView) {
        ...
        compBuilder.SetViewComponentViewInitializer([name](const winrt::Microsoft::ReactNative::ComponentView &view) noexcept {
          auto userData = winrt::make_self<TUserData>(name);
              if constexpr (
                  ...
                  &winrt::SampleCustomComponent::BaseFabricXamlControl<TUserData>::Initialize) {
        ...
        if constexpr (
            ...
            &winrt::SampleCustomComponent::BaseFabricXamlControl<TUserData>::CreateVisual) {
