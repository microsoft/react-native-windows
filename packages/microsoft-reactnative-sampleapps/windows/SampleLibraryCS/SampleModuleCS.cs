...
namespace SampleLibraryCS
{
    ...
    internal sealed class SampleModuleCS
    {
        ...
        {
            Debug.WriteLine($"C# globalProps.Prop1: {reactContext.ContextAbi.GlobalProperties.GetProperty(ReactPropertyBag.GetName(null, "Prop1"))}");
            Debug.WriteLine($"C# instanceProps.Prop2: {reactContext.ContextAbi.InstanceProperties.GetProperty(ReactPropertyBag.GetName(null, "Prop2"))}");
