...
namespace TestKeys {
vector<string> BasicRW = {"key0", "key1", "key2", "key3", "key4", "key5", "key6", "key7", "key8", "key9"};
...
vector<string> NewLinesAndBackSlashes = {
...
KVPair RandomRW100 = {
    ...
    make_tuple("%*B*lg(wjp^dhu7hZ16KmdWF&Ht$Ez7ii$bCqU$1MR", "Rboa3VZffyHvxd7OSIcl*9^Om5a7ptOEVf(d0I9nzw$$0&5bOKy20qB"),
    make_tuple(
        "PTvydSOvVY!%*GqNySdpj2!Eiuo1K)M6mB79cY!Mg6&ZQ*",
        "qswB2$Dtvtm8$vGb9zek0WhdvmCc&uzfP2jm%i$@7oF4l#(W^Bs847j^HokAQV7j*HVhmblyr9!PEIEbZ0oha0$b$vj7nk1T"),
    make_tuple("Nlhk&*(2h2@F%DK3t!P6ElkXaSn", "FF32VNP(w^q%IeK^ceinfOze6p8enGI^!YiRK8VL1ZNE9*ZFhdaU119miK%%iKyeNM"),
    make_tuple(
        "HdfJmZKAi0RwtXljKZMFROQ#llFNNLqZ&eQkP&nyk1!FnYqxnQQC^#r!(W4U^Ntko",
    ...
    make_tuple("Lkeukqe&MQEKMf", "Fun6$MlCkPtLcqLR1FUn$q2V(ZeVX7F042FJ%lCp@Y&#2H#$)^JW*iTZkh@CD#wA*oHj7KfR*"),
    make_tuple("ly$KTfqXq0OlR1Mf", "!0V(6f*AqsigMztDTV@b7hG@#PmB*5s@Y@&Pb4P*nq6L0bFjGYY5gV(*jNkJ"),
    make_tuple(
        "gWsR60CMV1Xc)E)rFTXm0d#vO@XzvOj6h#D@UIC%%8g5d7D!A6OUERExllFaa2SZBykTGf0s9u&ekm@iMjxWUN",
    ...
    make_tuple("BThtg%tw2o*ZAyLtgCdKU4#Cacu6UYYtMwtjpq24Fpxyn^wZUKYAE3w", "Jo@PjS9zN*UY!c*WhV^5^IO6!"),
    make_tuple("60W", "Xh(9TeR2DxeE56cDl4%N18gf6Nf0Z"),
    make_tuple("v1%5k037I)Mq%mq&YU$aXSCa3QrghZyBWDMjD2", "j*IY&fmE*&XXBsgxfBx8Az!ZtCrnz#zufr2DBQETX12e!6j4tdLB2"),
    ...
    make_tuple("ZS^kK&SpAkppO3NavQPsJku4M2tiiiG(an^iiqr((smDjsON)AdI5d$WZdB", "6XS*RJ#M#3rwMIG&O#)2hNEd#F12qowDnc"),
    make_tuple("fNc1Ge#2t#a0^3@Z1hVXM%qKT&y", "l5Bk99*crsi6mQwHY2vn&fN*EQni%eWx(dHWtuFBseU$g)&Y8uDIHE!0WtWdiJnLu8y3J"),
    make_tuple(
        "cm%1ipOhHL!WhiG*$gOWUn@*L#AZxai2CDgeS9kO%saDnCSQTD^1AddV@SdvxPpN!Y*2mV^yIEfH710Q@&*",
        "6c#YSX@2^b&PWcmO"),
    make_tuple(
    ...
    make_tuple("))c8PF1uGp9AoQ2paw2hsC2*JERyj*TYI$y)NR&cWO@CE92YGeslJjg#V6PLV4tlSDSYTbK)fF^", "GPxizp"),
    ...
    make_tuple("Vog", "^cvN$$IrDN1EEh^zv)Nd#iM&K*b&!FZY(g#$45#!R(xKHTvtk!)A!m&A9ZTmW4j!bDpsl9V4AMvAP3KP1b#By*eUF"),
    make_tuple("WiEV6&UlHN6*Ww0(ux", "*uh5k1Mxxs4Cxc$f!8HrhqCk%8OaKH%E@H3GW61$%XVHR#C4pd"),
    make_tuple(
        "lhZ3k5RUGOcbNYT0RpzA66leU&8IS0re&Lx5TVRLO97El&f!psDn@OLkBRUFIe^^#W)zSNnjlG*7!2eG5",
        "%M&JpjlkG#95P@7CdmB&3eNvHEIfPj2MSpQvDmvQF*qyK&bSuwCFv^WkjC11Iix!aOv1QSfesk&"),
    make_tuple("V!wQ7!pof%", "BAhk7kICZwguyFkungl%NBirNZtmBfIxn*mpE%JKG8fViqFZ4v&y58^*m$VrEit2H#Ki^SN"),
    make_tuple(
        "D^0yZxB(W#&7D6cV!Iazt%U7gh^gsLBXeBZ(J!NHr6QOCmtLYco#FQZkqk9RrTq)(%n5bcBsOF*)vj!Emgq&vKW7Q7k#s2",
    ...
    make_tuple("uI#ipgevS$ZlTenfhXV7*IRG^ZZc^kE09B66Qn#3#", "rrqJG6e2@dk&Ow!%1MrK3bs86TId31AlomXTwk"),
    make_tuple(
        "J%l5tWcg116*CQcx9oB&aau67D5qW*s)SPKoR(dI72KG191",
    ...
    make_tuple("z05OiC$$Yvn*QByRR!hZPWe8GKinbEMcsoCgQI8Qi6tBMjKG!LQym#W9VyHJSqle", "hM&K7E&DG*VrTrtTlPkA9A&rT"),
    make_tuple(
        "DUd@PulqhQlalD4IKeFhE*)!PVUuFnUEYW74vVrgxrGN9CJ)JgHWOOj(PpeNMSiOpz43B2KaRI3qH@JiDn1p06Oyni*#DAf(",
    ...
    make_tuple("%OLo$g)v", "^b&sKTeE#vl#0Vfdsvo2NrzDDD%l3P%zlxkalz@shm0Rz)CSiFjLbS&tJB0VCH"),
    make_tuple(
        "YbdoetSQ($Es7($*qn@JN5%I4dXnfiIE1pV7sSHec6njfoRSTXYDn9*iJv9wBrQnh2vep",
    ...
    make_tuple("znA^ovx*lNZBsTKW!lRDx4P#uV@*LaV^VM%2Cm0(9VMNA%ZP*yrDX", "68BhVetdCDk!c(uf1DYzRkiYZdtb7SSH97yv91a1F"),
    make_tuple("gW0CcrVg*%Wyb)a2BU85S#kqLk)Uk1xWZNMIpr4&8Mka9zuV%QeM&#GXtk#(Vc5Yy!!Y#X", "Tc9TK$EnCP2dlGhz$4o*jQy3lC("),
    make_tuple(
        "CsU*2)5e2Zq8yq!B)dg*XZcACXx7%Tok*pbgKwE",
    ...
    make_tuple("G9KnS@nd9^l!R7x", "!JjH!nsQ11k5HazcTtj6sh8IqokB!FQe(XDXVm@MgpPXJ66qyaR0I"),
    make_tuple(
        "c5ZDtGqRKtjLlu#4KDP4IXnEWt",
        "g#V^2soTo8var2o&e(FOWVG3Zm1VQUXCPPTPp)$SI%l#FG3iX6*MG5KQyAkB7%SLxA*wgxp^H&%Uab9JBEs@t1Y"),
    make_tuple("jV9WlM2Gt0oe", "L^Rp#r6hafSP1A0jAwy5m*PCgzum3IpKQ7#&r)k%(KV^fqR$cXBE!wIHn$zyyFX"),
    make_tuple("8)(^g*XTnSfDvbVw", "qn#Moo*1h5#nq4Lv%$W%2"),
    make_tuple("kI#4yj!qC!YpzyYFblS8hakhxQ8hMtGB&WO^pC!)T2qJCVhQj", ")#kMpLURPYB&XEb4IVFDW@E@Xq%eOHzD"),
    make_tuple(
        "!LQcJyEFF**jhA&E%5xTqZr8Tw01$6gpKD6tk*C15nP8BPIcavxNqXqnNAAJz(aNEGRkP^l%K5lq7Ba83g%c9t",
    ...
    make_tuple("nv5ARDIlGea&0ZPEo5C*lKW%kQjtFX2hLWl!e774O", "a@601Im^Wh7rXv$52o0gzmvw"),
    make_tuple(
        "T4lUoOjQcAg!r6np#bdcvRh*bHnY4F2ksDxIfipJNb6Z$8M&g0SLQzj4SDgdA38szJ#Fww5k",
    ...
    make_tuple(
        "N^L@t)RVWI0LrwhZoesCwt5szpLs)b@(vEBQvS$3$#b1(qqkR5q7VHr#y%jkiuOJ!d)jopQBtk#e^GVDi2q6*ra5iikb2",
        "R517Oz9"),
    make_tuple("fJ^otwjJ9FW*GRSEgPKGCypX&*mN8dQPW", "grf*P0qrHp8@STopRtZlLuGrBS@Y4n8GiLgtkQ08@4ryLrvBi*I!#&dS&@JJXT"),
    make_tuple(
        "lrUKwNvB0uMtLYBA)8IsvgU*fQyCR4B16dH#cPtIvghIQydV0XlziqFUSlIypiBF!d%HpC@EvaS#&zSEDXbjeiGAraq)benDi",
        "!B"),
    make_tuple("&qlfL4%", "$qOS7@h8eTNeUP"),
    make_tuple("Jiw^R5ozI*(WAm2vsJC%1gpayx0iL*VqzXY@@n140xOI*Rn5mH#ND5iUMYE9L*4*EUlDld7Duy(r", "I42EW3TvTNkTR4NB"),
    make_tuple("ow#NkSy%xDN(bXSx)3B1h%kejZ2wZ(UQe5kloj)rsyI28%S", "eBdrO7IZ1%%zpDIlXbphHD3jYdvH(J)4(GEOYE^*4M)Pns"),
    make_tuple(
        "0@xPnHKht*(I2IzIq)7xSTnn0q^Oq43I3ZuaHsv43ncRccCwhdx^%tB7NQ1QqfpD13%W$Go1t03RYk0dgaZIK^c2xiZ&hzv",
        "9j6YBu7c62DFN6hHZ9uklYw@A4z2hKrAb*MQaq!*O7bLMdId@cXB%ktxm"),
    make_tuple("8ItW6ewZH3$*N*uTGLzHlE)RSJ", "FWTkGKL$AEp*7S4oRLIVivkvVqFauuQW9ma6JUkF^D0f@q2#rlzMr#ml"),
    make_tuple(
        "C3teRiIUWteo&)XIDT1%SINlcrOT18US$7xyZ!nrKBgT^@DH&r&0iPPEV^Givv5QRo7AJimDFbjWF4SYZR#Jn4Ab!",
    ...
    make_tuple("2vxer47N0#0LY9&(@YcTk&o6", "Q)^0RllB@Cfih%3dhweRfqALR!8Gwnd(yrG$4B9#"),
    make_tuple(
        "ha2TpdGIBq#rK*mozjGWy3$89q53LPR1BH#$mwC#sl5b&gi0dAgQwo^zdh",
...
KVPair SimpleNewLinesAndBackSlashes = {
    make_tuple("\nE7Vf\n", "c%#Vb3gY7K\\"),
...
KVPair NewLinesAndBackSlashes = {
    ...
    make_tuple("djZQQRR5soenaOVoS(^f\n3PxckO3eP&p3CE9ez\nGUoZzIEF2^bUNY*9TE$Ktlto6-mzlAiW1pR*fkZnjweHuB$CP2AE6eJpjirmx9YD3%CndE2Jx^8WQ5F$b^(v\\", "ob=6=7%Fk3ecQ00p7$l&s^0u=(0ps#K\nX-44Y(g%cIP$1gJ$AtLAdPg!)(WMO3qC7P(PoUg5mOFcf$bzxD&v4%Z)J%Lp\n\\oWx)4*96*nCNqT)JIo9eE"),
    make_tuple(
        "1hl3qz8q(4UgYrF1z*z97Ph&5LwXbE(DL5BOhG2t9ohWQVN#o3*EZAHamFV0QYwG)xJIhJ@zn4@Cqw3qL%w-KCrR$hEmr9Hz#Zcglr!0TJf!7X3Qq(B$n0%LF0YeQZ\nbx4NLEjWBdOn",
    ...
    make_tuple("\nn94))almhNay21q5!zgR\nQSACT^YIrS*B5F(O3)Q3D5vpIYrjOcvyDhQlYxN)Mp2Js8DR\nuLh59%8=L%OH6aV", "vbjKRvkp*#NMmQ2VJNvaQ(R)PruxhQ\\j-0qaPmcWjt1mUA=Ch-r7rjmvA\\\\YC)9O0#OZRhj$a4iEbUUM2E!tQ3kJHoP4sj)Qvoba!j6Ewq=K9"),
    make_tuple(
        "pn(olGA03mf88QRg757st-ADLZ9Cjk7p@2oEu6ebyQfjs#ZTzv1DqKzYxCxh\nqMNmK=4dXVAyB0wMl1#A!Jo\ngpc7km6L1=\\Sck=X%ufh9l",
    ...
    make_tuple("\n-%uq$CQnk=68xNuIb)zLkD##Sk*oKM\nbri2phXjW*978fUn6vD#bSLLkpvmVy#$b74ziLNuaCA1MoahWUN!X)UL8ZRdd*zHnm)mL$$MB(XuwvyQ-MVEElF(=W^h#ewCek%S@Q@Lt", "xk4-lsd4b)R(9!h)0^WFqpbJQDzIf@O5)m9nU=BFg11JO\n5-LKHB1u4\n\nM@XyNpPZ$NrmpfXs^Ha1ULcaQ(go1ZG*W-t*0#Ir(nO0&xhDBB&PpOoVCH1maj7g6q"),
    make_tuple(
        "dV@jLZYNW^g@OZC9eH6Q4TxPSloNiXX$P$bz5Wj0F2Lyi2T-TzCjShrQ-4XOfw@7SOm9R^1C(XE\nMFvRxo#(tJ2WR64Y@322Aq-H7=LATP3AnWGI28zV9V4&$JglWihI@o\\",
    ...
    make_tuple("=FVWVK%k*qJ5\\%J%3z9$NyBhadhxLUq#L\\z2e30#^%9X!!RiXGPHGO70@p(qXwf!cHYu!bWLh2wc!1gqpf#kX0McqAqVN\\fv9Gc1IghPAy%EkPgeV6zlrqwZ449S9r=SGE!c-!!)", "R&!$jbd=QQZ9r5ma!VZ3ofUkO#mD0ifCCizG!lN5Nx!72!m6#GdquLAsVUBO8lX!ILDjD-iuQU@XWdB0y=XmAkAF^xXY#t@hPhe8s@D)jURa4ufKaNyKrqA8&p5=Q5Ka*&c"),
    make_tuple(
        "\n\n\\\n\n9!w5C4xU%!8SDy@$l5jfAx8#wdX\\\nVVV!$vFIo345",
...
TEST_CLASS (AsyncStorageTest) {
 ...
 private:
  inline void cleanupStorageFiles() {
    ...
    HRESULT hr = SHGetFolderPathW(nullptr, CSIDL_APPDATA, nullptr, SHGFP_TYPE_CURRENT, myAppDataDirPathArr);
    if (hr != S_OK)
      throw std::exception("Error: could not find the appdata");

    std::wstring myAppDataDirPath(myAppDataDirPathArr);
    std::wstring myAppDataFilePath = myAppDataDirPath + L"\\" + m_storageFileName + L".txt";
 ...
 public:
  ...
  TEST_METHOD(AsyncStorageTest_RandomRW100) {
    ...
    Assert::IsTrue(results == TestData::RandomRW100, L"Read does not match write");
  ...
  TEST_METHOD(AsyncStorageTest_RandomRW1024) {
    ...
    Assert::IsTrue(results == TestData::RandomRW1024, L"Read does not match write");
  ...
  TEST_METHOD(AsyncStorageTest_Remove) {
    ...
    vector<string> expectedKeys = {"key0", "key2", "key3", "key5", "key6", "key7", "key8", "key9"};
  ...
  TEST_METHOD(AsyncStorageTest_Persistance1) {
    ...
    kvStorage = make_shared<KeyValueStorage>(this->m_storageFileName); // should load from file now
  ...
  TEST_METHOD(AsyncStorageTest_Persistance3) {
    ...
    vector<tuple<string, string>> setVector = {
    ...
    vector<tuple<string, string>> expected = {
        make_tuple("key0", "value0"),
        make_tuple("key1", "newvalue1"),
        make_tuple("key2", "value2"),
        make_tuple("key3", "newvalue3"),
    ...
    auto results = kvStorage->multiGet(TestKeys::BasicRW);
    Assert::IsTrue(results == expected, L"results were not correct before the persistance portion");

    kvStorage = nullptr; // kill object
    kvStorage = make_shared<KeyValueStorage>(this->m_storageFileName); // should load from file now

    auto resultsAfterLoad = kvStorage->multiGet(TestKeys::BasicRW);
    Assert::IsTrue(resultsAfterLoad == expected, L"results were not correct after the persistance portion");

    kvStorage->clear();
  }

  TEST_METHOD(AsyncStorageTest_Persistance4) {
    auto kvStorage = make_shared<KeyValueStorage>(this->m_storageFileName); // setup
    kvStorage->clear();
  ...
  TEST_METHOD(AsyncStorageTest_SimpleEscaping) {
    ...
    auto resultsAfterLoad = kvStorage->multiGet(TestKeys::SimpleNewLinesAndBackSlashes);
  ...
  TEST_METHOD(AsyncStorageTest_Escaping) {
    ...
    auto resultsAfterLoad = kvStorage->multiGet(TestKeys::NewLinesAndBackSlashes);
