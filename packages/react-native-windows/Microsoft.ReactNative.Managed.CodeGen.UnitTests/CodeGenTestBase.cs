...
#pragma warning restore CS0162
        ...
        private string GetRelativeLkgPath(string lkgName)
        {
            ...
            return Path.Combine("Lkg", TestContext.FullyQualifiedTestClassName.Substring("Microsoft.ReactNative.Managed.CodeGen.UnitTests.CodeGen.".Length) + "--" + TestContext.TestName + suffix + ".lkg");
        }
