...
- Bump @react-native-windows/package-utils to v0.72.1
- Bump @react-native-windows/telemetry to v0.72.2
...
- Bump @react-native-windows/package-utils to v0.72.0
- Bump @react-native-windows/telemetry to v0.72.0

## 0.72.0-preview.6

Mon, 19 Jun 2023 15:16:08 GMT

### Changes

- Bump @react-native-windows/telemetry to v0.72.0-preview.5
...
- Bump @react-native-windows/telemetry to v0.72.0-preview.4
...
- Cherry Pick (34109996+chiaramooney@users.noreply.github.com)
- Bump @react-native-windows/telemetry to v0.72.0-preview.3
...
- Bump @react-native-windows/package-utils to v0.72.0-preview.1
- Bump @react-native-windows/telemetry to v0.72.0-preview.1
