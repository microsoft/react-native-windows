...
struct CommandHandler : HandlerT<CommandHandler> {
  ...
  AutomationChannel::CommandHandler BindAsyncAction(const winrt::hstring &methodName, const AsyncAction &action) noexcept;
  AutomationChannel::CommandHandler BindOperation(const winrt::hstring &methodName, const SyncOperation &operation) noexcept;
  AutomationChannel::CommandHandler BindAsyncOperation(const winrt::hstring &methodName, const AsyncOperation &operation) noexcept;
