...
exports.examples = exports.description = exports.title = exports.displayName = exports.styles = exports.TextExample = exports.BackgroundColorDemo = exports.AttributeToggler = exports.Entity = void 0;
...
class AttributeToggler extends React.Component {
    constructor() {
        super(...arguments);
        this.state = { fontWeight: 'bold', fontSize: 15 };
        this.toggleWeight = () => {
            this.setState({
...
exports.BackgroundColorDemo = BackgroundColorDemo;
    ...
    render() {
        ...
        return (React.createElement(RNTesterPage, null,
            ...
            React.createElement(RNTesterBlock, { title: "Nested" },
                React.createElement(react_native_1.Text, { onPress: () => console.log('1st') },
                    "(Normal text,",
                    ...
                    React.createElement(react_native_1.Text, { style: { fontWeight: 'bold' }, onPress: () => console.log('2nd') },
                        "(and bold",
                        React.createElement(react_native_1.Text, { style: { fontStyle: 'italic', fontSize: 11, color: '#527fe4' }, onPress: () => console.log('3rd') },
                            "(and tiny bold italic blue",
                            React.createElement(react_native_1.Text, { style: { fontWeight: 'normal', fontStyle: 'normal' }, onPress: () => console.log('4th') }, "(and tiny normal blue)"),
                            ")"),
                        ")"),
                    ")"),
                React.createElement(react_native_1.Text, { style: { fontFamily: 'serif' }, onPress: () => console.log('1st') },
                    "(Serif",
                    React.createElement(react_native_1.Text, { style: { fontStyle: 'italic', fontWeight: 'bold' }, onPress: () => console.log('2nd') },
                        "(Serif Bold Italic",
                        React.createElement(react_native_1.Text, { style: {
                            ...
                            "(Monospace Normal",
                            React.createElement(react_native_1.Text, { style: { fontFamily: 'sans-serif', fontWeight: 'bold' }, onPress: () => console.log('4th') },
                                "(Sans-Serif Bold",
                                React.createElement(react_native_1.Text, { style: { fontWeight: 'normal' }, onPress: () => console.log('5th') }, "(and Sans-Serif Normal)"),
                                ")"),
                            ")"),
                        ")"),
                    ")"),
            ...
            React.createElement(RNTesterBlock, { title: "backgroundColor new examples" },
                React.createElement(BackgroundColorDemo, null)),
