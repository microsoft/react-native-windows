    ...
    render: function (): React.Node {
      return (
        <Image
          ...
          onAccessibilityAction={(event) => console.log('Action:', event.nativeEvent.actionName)}
    ...
    render: function (): React.Node {
      return (
        <Image
          ...
          onAccessibilityAction={(event) => console.log('Accessibility Action:', event.nativeEvent.actionName)}
