...
class AccessibilityHeadingAndLandmarkExamples extends React.Component {
  public render() {
    return (
      <View>
        <View
          ...
          <Text>
            This text is within "Main" accessibilityLandmarkType. Enable scan
            mode to hear Narrator announce Headings and Landmarks.
          </Text>
        </View>
        <View
        ...
        <Text accessibilityRole="header">Heading Level 2 text</Text>
      </View>
    );
  }
}
...
export const examples = [
  ...
  },
  {
    ...
    render: function(): JSX.Element {
      return <AccessibilityHeadingAndLandmarkExamples />;
    },
  },
];
