    ...
    <View>
      <View>
        ...
        >
          ...
          <Text
            style={{ color: 'red' }}
            onPress={() => setPressedCountNested(pressedCountNested + 1)}
            accessible={true}
            accessibilityLiveRegion="polite"
          >
            Pressed {pressedCountNested} times
          </Text>
        </Text>
        <Text
          style={{ color: 'green' }}
      ...
      <View>
        <MyView
          ...
          accessibilityState={{ checked: true, expanded: true }}
