...
class BlobImage extends React.Component<BlobImageProps, BlobImageState> {
  ...
  render(): React.Node {
    return this.state.objectURL !== null ? (
      <Image source={{uri: this.state.objectURL}} style={styles.base} testID="image-blob" accessible/>
    ) : (
  ...
  render(): React.Node {
    return (
      <View style={styles.flexRow}>
        <Image style={styles.imageSizeExample} source={this.props.source} testID="image-size" accessible/>
        <Text>
          Actual dimensions:{'\n'}
...
exports.examples = [
  {
    ...
    render: function (): React.Node {
      return <Image source={fullImage} style={styles.base} testID="image-plain-source" accessible/>;
    },
  },
  {
    ...
    description: ('If the `src` prop is defined with ' +
      '"http", then it will be downloaded from the network.': string),
    render: function (): React.Node {
      return <Image src={fullImage.uri} style={styles.base} testID="image-plain-src" accessible/>;
    },
  },
  {
  ...
  },
  {
    ...
    render: function (): React.Node {
      return (
        <View style={styles.horizontal} testID="image-border-radius" accessible>
          <Image
  ...
  },
  {
    ...
    render: function (): React.Node {
      return (
        <View style={styles.horizontal} testID="image-background-color" accessible>
  ...
  },
  {
    ...
    render: function (): React.Node {
      return (
        <View testID="image-object-fit" accessible>
  ...
  },
  {
    ...
    render: function (): React.Node {
      return (
        <View testID="image-resize-mode" accessible>
          {[smallImage, fullImage].map((image, index) => {
            return (
              <View key={index}>
                <View style={styles.horizontal}>
  ...
  },
  {
    ...
    render: function (): React.Node {
      return (
        <Image style={styles.base64} source={{uri: base64Icon, scale: 3}} testID="image-base64" accessible/>
      );
    },
    platform: 'ios',
  },
  ...
  },
  {
    ...
    render: function (): React.Node {
      return <Image source={{uri: 'legacy_image', width: 120, height: 120}} testID="image-legacy" accessible/>;
    },
  },
  {
    ...
    render: function (): React.Node {
      return (
        <View style={styles.flexRow} testID="image-bundled" accessible>
          <Image
            source={{
              uri: 'ImageInBundle',
  ...
  },
  {
    ...
    render: function (): React.Node {
      return <Image accessible source={fullImage} style={styles.base} testID="image-accessible"/>;
    },
  },
  {
  ...
  },
  {
    ...
    render: function (): React.Node {
      return (
        <>
          <Image fadeDuration={1500} source={fullImage} style={styles.base} testID="image-fade-duration" accessible/>
