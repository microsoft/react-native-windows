  ...
  },
  {
    ...
    render: function (): React.Node {
      return (
        <View>
          <RNTesterText
            style={{width: 500, height: 100, fontSize: 20,backgroundColor:'lightcoral',padding:10,marginBottom: 10}}
          ...
          {[           
              ...
              <React.Fragment key={index}>
                <RNTesterText testID={`text-adjustfontsizetofit-${index}-a`}
                numberOfLines={item.lineCount}
                adjustsFontSizeToFit
                style={{width: item.width, height: item.height, fontSize: 40,backgroundColor:'#A0C782',padding:10,marginBottom: 10}}>
                ...
                <RNTesterText testID={`text-adjustfontsizetofit-${index}-b`}
                numberOfLines={item.lineCount}      
                style={{width: item.width, height: item.height, fontSize: 40,backgroundColor:'lightblue',padding:10,marginBottom: 10}}>
