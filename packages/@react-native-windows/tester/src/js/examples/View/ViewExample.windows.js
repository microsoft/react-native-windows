    ...
    return (
      <View>
        <View testID="view-component-switch-view">
          ...
          <Switch onValueChange={this._handlePress} value={this.state.displayNone} />
          <Text>toggle display:none TextInput2</Text>
          <Switch onValueChange={this._handlePress2} value={this.state.displayNone2} testID="toggle-display:none"/>
        </View>
