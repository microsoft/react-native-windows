...
import {StyleSheet, View, Text /*, Dimensions*/} from 'react-native'; // [Win32] Remove calls to Dimensions
...
// const ScreenWidth = Dimensions.get('window').width; [Win32] Remove calls to Dimensions
...
const styles = StyleSheet.create({
  ...
  examplesContainer: {
    // width: ScreenWidth, [Win32] Remove calls to Dimensions
    flexGrow: 1,
  },
  description: {
    marginVertical: 8,
