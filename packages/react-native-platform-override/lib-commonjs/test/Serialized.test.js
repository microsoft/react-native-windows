...
test('Valid includePatterns', () => {
    ...
    expect(Serialized.parseManifest(JSON.stringify(manifest)).includePatterns).toEqual(includePatterns);
});
test('Valid excludePatterns', () => {
    ...
    expect(Serialized.parseManifest(JSON.stringify(manifest)).excludePatterns).toEqual(excludePatterns);
});
//# sourceMappingURL=Serialized.test.js.map