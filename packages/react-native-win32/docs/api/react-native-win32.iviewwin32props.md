...
|  [accessibilityDescription](./react-native-win32.iviewwin32props.accessibilitydescription.md) | <code>string</code> | accessibilityDescription provides more detailed information specific to the element (i.e. last edit date, full location for a file) while accessibilityHint provides infomation on what will happen when they perform an action. |
