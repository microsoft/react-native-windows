...
class BiDirectionalTestComponent1 extends React.Component<{}> {
...
class BiDirectionalTestComponent2 extends React.Component<{}> {
...
export const examples = [
    {
        title: 'BiDi ScrollView example col',
        description: '',
        render(): JSX.Element {
            return (
                <ViewWin32>
                    <BiDirectionalTestComponent1 />
                </ViewWin32>
            );
        },
    },
    {
        title: 'BiDi ScrollView example row',
        description: '',
        render(): JSX.Element {
            return (
                <ViewWin32>
                    <BiDirectionalTestComponent2 />
                </ViewWin32>
            );
        },
    },
