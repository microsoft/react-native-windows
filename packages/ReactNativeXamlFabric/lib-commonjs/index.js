...
exports.Button = exports.StackPanel = exports.FabricXamlControl = exports.XamlHost = void 0;
...
const FabricXamlControl = nativeComponentRegistry.get('FabricXamlControl', () => ({
    ...
    validAttributes: Object.assign({ label: true }, ConditionallyIgnoredEventHandlers({ onSelectedDatesChanged: true }))
}));
exports.FabricXamlControl = FabricXamlControl;
