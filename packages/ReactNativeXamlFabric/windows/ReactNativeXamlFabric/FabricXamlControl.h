...
namespace winrt::ReactNativeXamlFabric {
    ...
    struct FabricXamlControlProps : winrt::implements<FabricXamlControlProps, winrt::Microsoft::ReactNative::IComponentProps> {
        FabricXamlControlProps(winrt::hstring name, winrt::Microsoft::ReactNative::ViewProps props, const winrt::Microsoft::ReactNative::IComponentProps& cloneFrom)
      ...
      void UpdateProps(
        ...
        if (newProps->content.Type() == winrt::Microsoft::ReactNative::JSValueType::String) {
          ...
          xamlControl.SetValue(winrt::Microsoft::UI::Xaml::Controls::ContentControl::ContentProperty(),
              winrt::box_value(contentHString));
        } else if (newProps->content.Type() == winrt::Microsoft::ReactNative::JSValueType::Null) {
          //xamlControl.SetValue(winrt::Microsoft::UI::Xaml::Controls::ContentControl::ContentProperty, winrt::hstring{L""});
        } else {
          throw std::exception("Unknown content type");
        }
        
        //xamlControl.SetValue(winrt::Microsoft::UI::Xaml::Controls::Button::ContentProperty(), winrt::hstring{L"I am default button."});
      }
