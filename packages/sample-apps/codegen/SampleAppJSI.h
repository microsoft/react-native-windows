...
protected:
  NativeMyJsiModuleCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker);
...
template <typename T>
class JSI_EXPORT NativeMyJsiModuleCxxSpec : public TurboModule {
public:
...
protected:
  NativeMyJsiModuleCxxSpec(std::shared_ptr<CallInvoker> jsInvoker)
    : TurboModule("MyJsiModule", jsInvoker),
      delegate_(static_cast<T*>(this), jsInvoker) {}

private:
  class Delegate : public NativeMyJsiModuleCxxSpecJSI {
  public:
    Delegate(T *instance, std::shared_ptr<CallInvoker> jsInvoker) :
      NativeMyJsiModuleCxxSpecJSI(std::move(jsInvoker)), instance_(instance) {}
...
class JSI_EXPORT NativeMyModuleCxxSpecJSI : public TurboModule {
protected:
  NativeMyModuleCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker);
...
private:
  class Delegate : public NativeMyModuleCxxSpecJSI {
  public:
    Delegate(T *instance, std::shared_ptr<CallInvoker> jsInvoker) :
      NativeMyModuleCxxSpecJSI(std::move(jsInvoker)), instance_(instance) {}
