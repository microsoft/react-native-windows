...
winrt::NodeRpc::Handler Handler::Bind(const winrt::hstring &methodName, const RpcAction &action) noexcept {
...
winrt::NodeRpc::Handler Handler::Bind(const winrt::hstring &methodName, const RpcOperation &operation) noexcept {
  VerifyElseCrash(!IsMethodRegistered(methodName));
  VerifyElseCrash(!IsReservedMethodName(methodName));
...
winrt::NodeRpc::Handler Handler::Bind(const winrt::hstring &methodName, const AsyncRpcAction &action) noexcept {
  VerifyElseCrash(!IsMethodRegistered(methodName));
  VerifyElseCrash(!IsReservedMethodName(methodName));
...
winrt::NodeRpc::Handler Handler::Bind(const winrt::hstring &methodName, const AsyncRpcOperation &operation) noexcept {
  VerifyElseCrash(!IsMethodRegistered(methodName));
  VerifyElseCrash(!IsReservedMethodName(methodName));
