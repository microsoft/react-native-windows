...
const ovrRepo = new MockFileRepository_1.MockOverrideFileRepository(overrideFiles);
test('AllListedInManifest', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const errors = yield new Manifest_1.default(manifest, ovrRepo, reactRepo).validate();
    ...
    overrides: [
        {
            ...
            baseVersion: '0.61.5',
            baseHash: Manifest_1.default.hashContent(reactFiles[0].content),
            issue: 4567,
        },
        {
            type: 'derived',
            ...
            baseVersion: '0.60.6',
            baseHash: Manifest_1.default.hashContent(reactFiles[1].content),
            issue: 4568,
        },
        {
            type: 'platform',
...
test('FullManifestValid', () => __awaiter(void 0, void 0, void 0, function* () {
    const testManifest = new Manifest_1.default(testManifestData, ovrRepo, reactRepo);
...
test('OutOfDateFile', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const ourReactRepo = new MockFileRepository_1.MockReactFileRepository(ourBaseFiles);
    const expectedError = {
        type: 'outOfDate',
        file: overrideFiles[0].filename,
    };
    const testManifest = new Manifest_1.default(testManifestData, ovrRepo, ourReactRepo);
    const errors = yield testManifest.validate();
    expect(errors).toEqual([expectedError]);
}));
test('BaseFileNotFound', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const testManifest = new Manifest_1.default(ourManifestData, ovrRepo, reactRepo);
    const errors = yield testManifest.validate();
    expect(errors).toEqual([expectedError]);
}));
test('HasOverride', () => __awaiter(void 0, void 0, void 0, function* () {
    const manifest = new Manifest_1.default(testManifestData, ovrRepo, reactRepo);
...
test('addOverrideSimple', () => __awaiter(void 0, void 0, void 0, function* () {
    const manifest = new Manifest_1.default({ overrides: [] }, ovrRepo, reactRepo);
...
test('ManifestMutateDoesntAffectData', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const manifest = new Manifest_1.default(manifestData, ovrRepo, reactRepo);
    const patch = overrideFiles[0].filename;
    const patchOrig = reactFiles[0].filename;
    yield manifest.addPatchOverride(patch, patchOrig, 1234);
...
test('MarkUpToDateOutdated', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const manifest = new Manifest_1.default(ourTestData, ovrRepo, reactRepo);
    ...
    expect(updated.baseHash).toBe(Manifest_1.default.hashContent(reactFiles[0].content));
}));
