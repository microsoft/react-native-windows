...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const version = yield ReactVersion_1.getInstalledRNVersion(ovrPath);
...
function tryAddCopy(filename, rnVersion, override, reactSources, manifest) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        manifest.overrides.push({
            ...
            baseHash: Manifest_1.default.hashContent(baseContents),
            issue: 0,
        });
        return true;
    });
...
function tryAddDerived(filename, rnVersion, override, reactSources, manifest) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        manifest.overrides.push({
            ...
            baseVersion: rnVersion,
            baseHash: Manifest_1.default.hashContent(bestMatch.contents),
            issue: 'LEGACY_FIXME',
        });
        return true;
    });
...
function getFileRepos(overrideovrPath, rnVersion) {
    return __awaiter(this, void 0, void 0, function* () {
        const overrides = new OverrideFileRepositoryImpl_1.default(overrideovrPath);
        const versionedReactSources = yield GitReactFileRepository_1.default.createAndInit();
