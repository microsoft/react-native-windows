...
import { bindVersion, } from './FileRepository';
import OverrideUpgrader from './OverrideUpgrader';
...
function doUpgrade(manifestPath, isManual, version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield spinnerGuard(spinner, () => __awaiter(this, void 0, void 0, function* () {
            const reactRepo = yield GitReactFileRepository.createAndInit();
...
function readManifest(file, version) {
    return __awaiter(this, void 0, void 0, function* () {
        const gitReactRepo = yield GitReactFileRepository.createAndInit();
...
function readManifestUsingRepos(file, ovrRepo, versionedReactRepo, version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const rnVersion = version || (yield getInstalledRNVersion(file));
