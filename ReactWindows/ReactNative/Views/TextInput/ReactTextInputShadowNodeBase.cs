...
namespace ReactNative.Views.TextInput
{
    ...
    /// </summary>
    public class ReactTextInputShadowNodeBase : LayoutShadowNode
    {
        ...
        /// </param>
        public ReactTextInputShadowNodeBase(bool isVirtual)
        {
        ...
        protected static void FormatInline(ReactTextInputShadowNodeBase textNode, Inline inline, bool measureOnly)
        {
        ...
        private static MeasureOutput MeasureText(CSSNode node, float width, CSSMeasureMode widthMode, float height, CSSMeasureMode heightMode)
        {
            ...
            var task = DispatcherHelpers.CallOnDispatcher(() =>
            {
                ...
                var textNode = (ReactTextInputShadowNodeBase)node;
