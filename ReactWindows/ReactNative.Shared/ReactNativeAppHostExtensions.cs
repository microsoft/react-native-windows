...
namespace ReactNative
{
    ...
    /// </summary>
    public static class ReactNativeAppHostExtensions
    {
        /// <summary>
        ...
        /// </param>
        public static void OnResume(this ReactNativeAppHost host, Action onBackPressed)
        {
        ...
        /// </summary>
        /// <param name="host">The React Native host.</param>
        public static void OnSuspend(this ReactNativeAppHost host)
        {
            if (host.HasInstance)
            {
        ...
        /// </summary>
        /// <param name="host">The React Native host.</param>
        public static void OnEnteredBackground(this ReactNativeAppHost host)
        {
            if (host.HasInstance)
            {
        ...
        /// </summary>
        /// <param name="host">The React Native host.</param>
        public static void OnLeavingBackground(this ReactNativeAppHost host)
        {
            if (host.HasInstance)
            {
        ...
        public static void ApplyArguments(this ReactNativeAppHost host, string arguments)
        {
