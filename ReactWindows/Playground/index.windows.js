...
class CustomControl extends Component {
  ...
  render () {
    ...
    return (
      <FocusableWindows
          ...
          tabIndex={0}
      >
        <Animated.View {...this.props} ref={(r) => this._r = r}
        >
          {this.props.children}
        </Animated.View>
      </FocusableWindows>
  ...
  _onKeyUp = (e) => {
    if (e.nativeEvent.keyCode === FocusableWindows.keys.Space) {
      Alert.alert("AHA", "Custom control pressed");
    }
  };

  setNativeProps(p) {
    this._r.setNativeProps(p);
  }
}
    ...
    return (
      <View style={styles.container}>
       ...
       <CustomControlAnim style={styleJsAnimated}>
        ...
        <TextInput style={styles.input} secureTextEntry={false} onKeyUp=
            {
              (e) =>
