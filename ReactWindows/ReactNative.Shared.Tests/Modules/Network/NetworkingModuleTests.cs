...
namespace ReactNative.Tests.Modules.Network
{
    ...
    public class NetworkingModuleTests
    {
        ...
        public void NetworkingModule_ArgumentChecks()
        {
            ...
            Assert.AreEqual("url", ex2.ParamName);
            ...
            Assert.AreEqual("responseType", ex3.ParamName);

            ArgumentOutOfRangeException ex4 = Assert.Throws<ArgumentOutOfRangeException>(
                () => module.sendRequest("get", new Uri("http://example.com"), 0, null, null, "", false, 0));
            Assert.AreEqual("responseType", ex4.ParamName);
        }
