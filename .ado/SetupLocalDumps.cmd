...
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\%1.exe\Core-{E5DCDFAA-3B35-46A8-B370-9D3575A68E53}" /f /v "Propagate" /t REG_DWORD /v 0
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\%1.exe\Core-{E5DCDFAA-3B35-46A8-B370-9D3575A68E53}" /f /v "AutoClr" /t REG_DWORD /v 0
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\%1.exe\Core-{E5DCDFAA-3B35-46A8-B370-9D3575A68E53}" /f /v "AutoDisableStop" /t REG_DWORD /v 1
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\%1.exe\Core-{E5DCDFAA-3B35-46A8-B370-9D3575A68E53}" /f /v "LoggingWithLocksHeld" /t REG_DWORD /v 1
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\%1.exe\Core-{E5DCDFAA-3B35-46A8-B370-9D3575A68E53}" /f /v "ExceptionOnStop" /t REG_DWORD /v 0
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\%1.exe\Core-{E5DCDFAA-3B35-46A8-B370-9D3575A68E53}" /f /v "MinimumMemoryOverhead" /t REG_DWORD /v 0
...
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\%1.exe\Leak-{81EEC8DA-0E61-4942-8037-9A6C4A86510D}" /f /v "ExcludeUCRT" /t REG_DWORD /v 0

reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\%1.exe\Memory-{8A70B8A4-4FA6-41c3-85EE-595FCB3E1051}" /f /v "ExecWritePage" /t REG_DWORD /v 0
