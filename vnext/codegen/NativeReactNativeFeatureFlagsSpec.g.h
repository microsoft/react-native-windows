...
struct ReactNativeFeatureFlagsSpec : winrt::Microsoft::ReactNative::TurboModuleSpec {
  static constexpr auto methods = std::tuple{
      ...
      SyncMethod<bool() noexcept>{4, L"changeOrderOfMountingInstructionsOnAndroid"},
      ...
      SyncMethod<bool() noexcept>{8, L"enableGranularShadowTreeStateReconciliation"},
      SyncMethod<bool() noexcept>{9, L"enableLongTaskAPI"},
      SyncMethod<bool() noexcept>{10, L"enableMicrotasks"},
      SyncMethod<bool() noexcept>{11, L"enablePropsUpdateReconciliationAndroid"},
      SyncMethod<bool() noexcept>{12, L"enableSynchronousStateUpdates"},
      SyncMethod<bool() noexcept>{13, L"enableUIConsistency"},
      SyncMethod<bool() noexcept>{14, L"fetchImagesInViewPreallocation"},
      SyncMethod<bool() noexcept>{15, L"fixIncorrectScrollViewStateUpdateOnAndroid"},
      SyncMethod<bool() noexcept>{16, L"fixMappingOfEventPrioritiesBetweenFabricAndReact"},
      SyncMethod<bool() noexcept>{17, L"fixMissedFabricStateUpdatesOnAndroid"},
      SyncMethod<bool() noexcept>{18, L"forceBatchingMountItemsOnAndroid"},
      SyncMethod<bool() noexcept>{19, L"fuseboxEnabledDebug"},
      SyncMethod<bool() noexcept>{20, L"fuseboxEnabledRelease"},
      SyncMethod<bool() noexcept>{21, L"initEagerTurboModulesOnNativeModulesQueueAndroid"},
      SyncMethod<bool() noexcept>{22, L"lazyAnimationCallbacks"},
      SyncMethod<bool() noexcept>{23, L"loadVectorDrawablesOnImages"},
      SyncMethod<bool() noexcept>{24, L"setAndroidLayoutDirection"},
      SyncMethod<bool() noexcept>{25, L"useImmediateExecutorInAndroidBridgeless"},
      SyncMethod<bool() noexcept>{26, L"useModernRuntimeScheduler"},
      SyncMethod<bool() noexcept>{27, L"useNativeViewConfigsInBridgelessMode"},
      SyncMethod<bool() noexcept>{28, L"useNewReactImageViewBackgroundDrawing"},
      SyncMethod<bool() noexcept>{29, L"useRuntimeShadowNodeReferenceUpdate"},
      SyncMethod<bool() noexcept>{30, L"useRuntimeShadowNodeReferenceUpdateOnLayout"},
      SyncMethod<bool() noexcept>{31, L"useStateAlignmentMechanism"},
  };
