...
struct ReactNativeFeatureFlagsSpec : winrt::Microsoft::ReactNative::TurboModuleSpec {
  static constexpr auto methods = std::tuple{
      ...
      SyncMethod<bool() noexcept>{20, L"enableMicrotasks"},
      ...
      SyncMethod<bool() noexcept>{25, L"enableTextPreallocationOptimisation"},
      ...
      SyncMethod<bool() noexcept>{29, L"fetchImagesInViewPreallocation"},
      ...
      SyncMethod<bool() noexcept>{38, L"removeNestedCallsToDispatchMountItemsOnAndroid"},
      ...
      SyncMethod<bool() noexcept>{42, L"useImmediateExecutorInAndroidBridgeless"},
      SyncMethod<bool() noexcept>{43, L"useModernRuntimeScheduler"},
      SyncMethod<bool() noexcept>{44, L"useNativeViewConfigsInBridgelessMode"},
      SyncMethod<bool() noexcept>{45, L"useNewReactImageViewBackgroundDrawing"},
      ...
      SyncMethod<bool() noexcept>{49, L"useRuntimeShadowNodeReferenceUpdateOnLayout"},
      SyncMethod<bool() noexcept>{50, L"useTurboModuleInterop"},
      SyncMethod<bool() noexcept>{51, L"useTurboModules"},
  };
