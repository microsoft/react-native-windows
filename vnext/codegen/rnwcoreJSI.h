...
public:
  ...
  virtual jsi::Value getElementById(jsi::Runtime &rt, jsi::Value nativeNodeReference, jsi::String id) = 0;
...
private:
  ...
  public:
    ...
    jsi::Value getElementById(jsi::Runtime &rt, jsi::Value nativeNodeReference, jsi::String id) override {
      static_assert(
          bridging::getParameterCount(&T::getElementById) == 3,
          "Expected getElementById(...) to have 3 parameters");

      return bridging::callFromJs<jsi::Value>(
          rt, &T::getElementById, jsInvoker_, instance_, std::move(nativeNodeReference), std::move(id));
    }
