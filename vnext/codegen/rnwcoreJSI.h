...
private:
  ...
  class JSI_EXPORT NativeNetworkingWindowsCxxSpecJSI : public TurboModule {
protected:
  NativeNetworkingWindowsCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker);
...
template <typename T>
class JSI_EXPORT NativeNetworkingWindowsCxxSpec : public TurboModule {
public:
  jsi::Value get(jsi::Runtime &rt, const jsi::PropNameID &propName) override {
    return delegate_.get(rt, propName);
  }
...
protected:
  NativeNetworkingWindowsCxxSpec(std::shared_ptr<CallInvoker> jsInvoker)
    : TurboModule("Networking", jsInvoker),
      delegate_(static_cast<T*>(this), jsInvoker) {}

private:
  class Delegate : public NativeNetworkingWindowsCxxSpecJSI {
  public:
    Delegate(T *instance, std::shared_ptr<CallInvoker> jsInvoker) :
      NativeNetworkingWindowsCxxSpecJSI(std::move(jsInvoker)), instance_(instance) {}
