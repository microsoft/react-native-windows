...
struct AccessibilityInfoSpec : winrt::Microsoft::ReactNative::TurboModuleSpec {
  static constexpr auto methods = std::tuple{
      ...
      Method<void(Callback<bool>) noexcept>{1, L"isHighTextContrastEnabled"},
      Method<void(Callback<bool>) noexcept>{2, L"isTouchExplorationEnabled"},
      Method<void(Callback<bool>) noexcept>{3, L"isAccessibilityServiceEnabled"},
      Method<void(double) noexcept>{4, L"setAccessibilityFocus"},
      Method<void(std::string) noexcept>{5, L"announceForAccessibility"},
      Method<void(double, Callback<double>) noexcept>{6, L"getRecommendedTimeoutMillis"},
  };
