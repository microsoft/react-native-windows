...
function PlatformColorsExample() {
  function createTable() {
    ...
    if (Platform.OS === 'ios') {
      ...
      colors = [
        {
          label: 'SystemAccentColorLight3',
          color: PlatformColor('SystemAccentColorLight3'),
        },
        {
          label: 'SystemAccentColorLight2',
          color: PlatformColor('SystemAccentColorLight2'),
        },
        {
          label: 'SystemAccentColorLight1',
          color: PlatformColor('SystemAccentColorLight1'),
        },
        {
          label: 'SystemAccentColorDark1',
          color: PlatformColor('SystemAccentColorDark1'),
        },
        {
          label: 'SystemAccentColorDark2',
          color: PlatformColor('SystemAccentColorDark2'),
        },
        {
          label: 'SystemAccentColorDark3',
          color: PlatformColor('SystemAccentColorDark3'),
        },
      ];
    }
