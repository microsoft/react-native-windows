...
class DatePickerExample extends React.Component<{}, IDatePickerExampleState> {
  ...
  public render() {
    return (
      <View>
        <Text style={ { padding: 10 } }>Please choose from the settings below:  </Text>
        ...
        />
        <Text>Date Changed event response: { this.state.selectedDate.toString() }</Text>
...
export const description = 'Component that allows a user to pick a date from a calendar display with uwp CalendarDatePicker.';
