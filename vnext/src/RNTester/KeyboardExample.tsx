...
class TabStopExample extends React.Component {
  public render() {
    const itemStyle: ViewStyle = { width: 120, height: 50, backgroundColor: 'aqua', justifyContent: 'center', alignItems: 'center' };
    ...
    return (
      <View>
        ...
        <Text>These 3 items should tab in the order of first, last, middle:</Text>
        ...
        <Text>Controls like Picker should also do the same tab in the order of first, last, middle:</Text>
        <View style={{flex: 1, flexDirection: 'row', justifyContent: 'space-between'}}>
