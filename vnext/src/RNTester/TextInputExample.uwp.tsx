...
// class WithLabel extends React.Component<{label: string}> {
//   public render() {
//     return (
...
// interface ITextEventsExampleState {
//   curText: string;
//   prevText: string;
//   prev2Text: string;
//   prev3Text: string;
// }
// class TextEventsExample extends React.Component<{}, ITextEventsExampleState> {
//   public state = {
//     curText: '<No Event>',
//     prevText: '<No Event>',
//     prev2Text: '<No Event>',
...
// class RewriteExampleKana extends React.Component<{}, any> {
//   constructor(props: {}) {
//     super(props);
//     this.state = {text: ''};
//   }
...
class SecureEntryExample extends React.Component<{}, any> {
  constructor(props: {}) {
    super(props);
    this.state = {text: ''};
  }
  public render() {
    return (
      <View>
        ...
        <Button
          title={'pressMe'}
          onPress={() => this.setState({text: 'awesome string'})}
        />
        <Text>
          {'abcd' + this.state.text}
...
// class TokenizedTextExample extends React.Component<{}, any> {
//   constructor(props: {}) {
//     super(props);
...
//   public onSelectionChange({nativeEvent: {selection}}: any) {
...
//   public placeAt(position: any) {
//     this.select(position, position);
//   }

//   public placeAtRandom() {
...
export const description = 'Single and multi-line text inputs.';
export const examples = [
  ...
  //   render: function() {
  //     const keyboardTypes: ReactNative.KeyboardTypeOptions[] = [
  //       'default',
  //       'ascii-capable',
  ...
  //   render: function() {
  //     const returnKeyTypes: ReactNative.ReturnKeyTypeOptions[] = [
  //       'default',
  //       'go',
  //       'google',
  //       'join',
