...
AsyncStorageModule::getMethods() {
  return {
      ...
      Method(
          ...
          {
            m_asyncStorageManager->executeKVOperation(
                AsyncStorageManager::AsyncStorageOperation::multiRemove,
                args,
                jsCallback);
          }),
...
std::unique_ptr<facebook::xplat::module::CxxModule> CreateAsyncStorageModule(
