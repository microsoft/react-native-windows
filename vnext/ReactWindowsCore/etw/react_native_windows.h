...
#define EventWriteNATIVE_END_SECTION(id, tag, profileName, duration) \
  ...
  ? McTemplateU0xxsg(                                                \
        ...
        duration)                                                    \
  : 0
#define EventWriteNATIVE_END_SECTION_AssumeEnabled( \
    id, tag, profileName, duration)                 \
  McTemplateU0xxsg(                                 \
      &REACT_NATIVE_WINDOWS_Context,                \
      &NATIVE_END_SECTION,                          \
...
#define McTemplateU0xxsg_ARGCOUNT 4
  ...
  return McGenEventWrite(
      Context, Descriptor, NULL, McTemplateU0xxsg_ARGCOUNT + 1, EventData);
}
...
#define McTemplateU0xxsssssssss_ARGCOUNT 11
  ...
  EventDataDescCreate(
      ...
      (_Arg10 != NULL) ? (ULONG)((strlen(_Arg10) + 1) * sizeof(char))
                       : (ULONG)sizeof("NULL"));
  ...
  return McGenEventWrite(
      ...
      Descriptor,
      NULL,
      McTemplateU0xxsssssssss_ARGCOUNT + 1,
      EventData);
}
