...
class IteratorFacade {
 public:
  ...
  template <class D2, // [ Begin patch from https://github.com/facebook/folly/pull/1329/files
    std::enable_if_t<!std::is_same<D, D2>::value, int> = 0,
    std::enable_if_t<std::is_convertible<D, D2>::value, int> = 0>
  bool operator==(D2 const& rhs) const { // ] End patch from https://github.com/facebook/folly/pull/1329/files
