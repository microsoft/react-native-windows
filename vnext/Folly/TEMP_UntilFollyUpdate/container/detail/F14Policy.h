...
class ValueContainerIterator : public ValueContainerIteratorBase<ValuePtr> {
 ...
 public:
  ...
  friend bool operator==(ValueContainerIterator const& lhs, // [ Begin patch from https://github.com/facebook/folly/pull/1544/files
  ...
  friend bool operator!=(ValueContainerIterator const& lhs,
                         ValueContainerIterator const& rhs) {
    return !(lhs == rhs); // ] End patch from https://github.com/facebook/folly/pull/1544/files
  }
