...
class basic_fbstring {
 ...
 public:
  ...
  typedef typename std::allocator_traits<A>::size_type size_type; // [ Begin patch from https://github.com/facebook/folly/pull/1329/files
  ...
  typedef typename std::allocator_traits<A>::const_pointer const_pointer; // ] End patch from https://github.com/facebook/folly/pull/1329/files
