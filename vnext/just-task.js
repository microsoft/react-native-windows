...
function codegen(test) {
  execSync(
    `react-native-windows-codegen --files Libraries/**/*Native*.js private/**/*Native*.js --namespace Microsoft::ReactNativeSpecs --libraryName rnwcore --modulesWindows --modulesCxx${
      test ? ' --test' : ''
    }`,
    {env: process.env},
  );
