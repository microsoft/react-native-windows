...
namespace ABITests {
TEST_CLASS(MemoryTrackerTests){TEST_METHOD(Handler_AddedAndRemoved){
...
TEST_METHOD(ThresholdHandler_Called) {
  ...
  auto manualMessageQueue = std::make_shared<TestMessageQueueThread>(
      TestMessageQueueThread::Mode::ManualDispatch);
