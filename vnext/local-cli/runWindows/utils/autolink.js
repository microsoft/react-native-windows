...
function updateAutoLink(verbose) {
  ...
  try {
    ...
    if (cppProjFile == null){
      console.log('AutoLink currently is only supported on  C++/WinRT main project.');
      return;
    }
    ...
    let generatedIncludes = '// NativeModules.g.h -- contents generated by "react-native run-windows"';
    const dependencies = config['dependencies'];
    let packageRegistrations = '#define REACT_REGISTER_NATIVE_MODULE_PACKAGES()';
