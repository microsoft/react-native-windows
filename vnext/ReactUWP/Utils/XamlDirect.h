...
typedef winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex XDPropertyIndex;
...
static winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirect GetXamlDirect() {
  thread_local static winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirect xamlDirect;
  if (xamlDirect == nullptr) {
    xamlDirect = winrt::Microsoft::UI::Xaml::Core::Direct::XamlDirect::GetDefault();
  }
  return xamlDirect;
}
