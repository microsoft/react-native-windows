...
void MenuFlyoutSubItemShadowNode::updateProperties(
...
MenuFlyoutSubItemViewManager::MenuFlyoutSubItemViewManager(
...
facebook::react::ShadowNode *MenuFlyoutSubItemViewManager::createShadow()
    const {
...
folly::dynamic MenuFlyoutSubItemViewManager::GetNativeProps() const {
  ...
  props.update(folly::dynamic::object("text", "string"));
