...
ScrollViewUWPImplementation::ScrollViewUWPImplementation(
  ...
  const auto snapPointManager =
      scrollViewContent.as<SnapPointManagingContentControl>();
...
void ScrollViewUWPImplementation::SnapToOffsets(
    ...
    switch (scrollViewer.HorizontalSnapPointsAlignment()) {
      case winrt::SnapPointsAlignment::Near:
        ScrollViewerSnapPointManager()->SetWidthBounds(
            0.0f, static_cast<float>(scrollViewer.ScrollableWidth()));
        break;
      case winrt::SnapPointsAlignment::Center:
        ScrollViewerSnapPointManager()->SetWidthBounds(
            static_cast<float>(scrollViewer.ActualWidth() / 2.0f),
            static_cast<float>(
                scrollViewer.ScrollableWidth() +
                (scrollViewer.ActualWidth() / 2.0f)));
        break;
      case winrt::SnapPointsAlignment::Far:
        ScrollViewerSnapPointManager()->SetWidthBounds(
            static_cast<float>(scrollViewer.ActualWidth()),
            static_cast<float>(
                scrollViewer.ScrollableWidth() + scrollViewer.ActualWidth()));
        break;
    }
    ...
    switch (scrollViewer.VerticalSnapPointsAlignment()) {
      case winrt::SnapPointsAlignment::Near:
        ScrollViewerSnapPointManager()->SetHeightBounds(
            0.0f, static_cast<float>(scrollViewer.ScrollableHeight()));
        break;
      case winrt::SnapPointsAlignment::Center:
        ScrollViewerSnapPointManager()->SetHeightBounds(
            static_cast<float>(scrollViewer.ActualHeight() / 2.0f),
            static_cast<float>(
                scrollViewer.ScrollableHeight() +
                (scrollViewer.ActualHeight() / 2.0f)));
        break;
      case winrt::SnapPointsAlignment::Far:
        ScrollViewerSnapPointManager()->SetHeightBounds(
            static_cast<float>(scrollViewer.ActualHeight()),
            static_cast<float>(
                scrollViewer.ScrollableHeight() + scrollViewer.ActualHeight()));
        break;
    }
  }
}
...
winrt::com_ptr<SnapPointManagingContentControl>
ScrollViewUWPImplementation::ScrollViewerSnapPointManager() const {
