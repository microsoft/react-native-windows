...
class MenuFlyoutShadowNode : public ShadowNodeBase {
 ...
 public:
  ...
  static void
  OnMenuFlyoutClosed(IReactInstance &instance, int64_t tag, bool newValue);
...
void MenuFlyoutShadowNode::createView() {
  ...
  m_isFlyoutShowOptionsSupported =
      !!(m_menuFlyout.try_as<winrt::IFlyoutBase5>());
...
/*static*/ void MenuFlyoutShadowNode::OnMenuFlyoutClosed(
...
void MenuFlyoutShadowNode::updateProperties(const folly::dynamic &&props) {
  ...
  // TODO: hook up view props to the flyout (m_menuFlyout) instead of setting
  // them on the dummy view.
...
void MenuFlyoutShadowNode::AdjustDefaultFlyoutStyle() {
  winrt::Style flyoutStyle({L"Windows.UI.Xaml.Controls.MenuFlyoutPresenter",
...
MenuFlyoutViewManager::MenuFlyoutViewManager(
...
folly::dynamic MenuFlyoutViewManager::GetNativeProps() const {
  ...
  props.update(folly::dynamic::object("horizontalOffset", "number")(
      ...
      "attachAsContextFlyout", "boolean")("placement", "number")(
      "target", "number")("verticalOffset", "number"));

  return props;
}

folly::dynamic
MenuFlyoutViewManager::GetExportedCustomDirectEventTypeConstants() const {
...
void MenuFlyoutViewManager::SetLayoutProps(
