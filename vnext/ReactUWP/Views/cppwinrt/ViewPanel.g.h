...
struct WINRT_EBO ViewPanel_base : implements<D, react::uwp::IViewPanel, Windows::UI::Xaml::IFrameworkElementOverrides, Windows::UI::Xaml::IFrameworkElementOverrides2, Windows::UI::Xaml::IUIElementOverrides, Windows::UI::Xaml::IUIElementOverrides7, Windows::UI::Xaml::IUIElementOverrides8, Windows::UI::Xaml::IUIElementOverrides9, composing, I...>,
...
struct WINRT_EBO ViewPanelT : implements<D, Windows::Foundation::IActivationFactory, react::uwp::IViewPanelStatics, I...>
{
...
#if defined(WINRT_FORCE_INCLUDE_VIEWPANEL_XAML_G_H) || __has_include("ViewPanel.xaml.g.h")
