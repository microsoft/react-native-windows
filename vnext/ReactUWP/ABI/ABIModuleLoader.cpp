...
ABIModule::ABIModule(const Microsoft::WRL::ComPtr<ABI::react::uwp::IModule>& module)
   : m_module(module)
{
...
std::vector<facebook::xplat::module::CxxModule::Method> ABIModule::getMethods()
{
  ...
  Microsoft::WRL::ComPtr<IIterable<IKeyValuePair<HSTRING, ABI::react::uwp::IMethodWithCallbackDelegate*>*>> methodsWithCallBackIterable ;
  Microsoft::WRL::ComPtr<IIterator<IKeyValuePair<HSTRING, ABI::react::uwp::IMethodWithCallbackDelegate*>*>> methodsWithCallBackIter;
  ...
  do
  {
    ...
    ret.push_back(facebook::xplat::module::CxxModule::Method(HSTRINGToString(key), [this, value](folly::dynamic args, Callback cb)
    {
      std::string str = folly::toJson(args);

      HSTRING para = StringToHSTRING(str);

      auto callback = Microsoft::WRL::Callback<ABI::react::uwp::IMethodCallback>(
...
std::vector<facebook::react::NativeModuleDescription> ABIModuleLoader::GetModules(const std::shared_ptr<facebook::react::MessageQueueThread>& defaultQueueThread)
{
