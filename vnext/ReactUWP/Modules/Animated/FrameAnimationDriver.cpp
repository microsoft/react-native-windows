...
namespace react { namespace uwp {
  ...
  std::tuple<winrt::CompositionAnimation, winrt::CompositionScopedBatch> FrameAnimationDriver::MakeAnimation(const folly::dynamic& config)
  {
    ...
    // Frames contains 60 values per second of duration of the animation, convert the size of frames to duration in ms.
