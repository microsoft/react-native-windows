...
{
  return {
    Method("setString", [](folly::dynamic args)
    {
      ClipboardModule::SetClipboardText(facebook::xplat::jsArgAsString(args, 0));
    }),
    Method("getString", [](folly::dynamic args, Callback cbSuccess, Callback cbFail)
    {
...
winrt::fire_and_forget GetClipboardTextAsync(facebook::xplat::module::CxxModule::Callback cbSuccess, facebook::xplat::module::CxxModule::Callback cbFail)
{
