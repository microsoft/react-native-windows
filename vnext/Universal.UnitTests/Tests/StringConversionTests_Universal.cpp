...
vector<string> SAMPLE_STR = {
  // Here we are testing some random ASCII characters, emojis, Chinese, Russian, Japanese, Greek, Hebrew, Polish, Serbian, Norwegian, a very long string and empty string.
  u8"21QQYrTfnTS2kKSb47H3mJs0NxfyMBYIkX1pTCuDeVHYqLhQhUo8OObPz8M8tZy2kJrFRy94JQuWH5yUivxkBsXAblv0TqvNwLOpq1Rgx5l6LNc8AMByHXk814GmcoKr",
  u8"ZR6ztxV2QksUIS1HHSQFL8uTXy2Tb23Vq3uuJlpwGAFtCPkVnMC7zf87eZSzLJFwNa4WKGZ6gkpBPPqsVUFJlVHwEAMMiYUUqb5JYi4tTsOgfV2q4lLC0j9QeDwTCN7Y",
  u8"🍅❓Ⓠ〰️®️✝️📧🌱⛎ℹ️🅾️🅿️🅰️💰↩️Ⓕ⛽️♓️☔Ⓚ🕒💤❌☪️♈️Ⓑ📈♍️",
  u8"😀 😁 😂 🤣 😃 😄 😅 😆 😉 😊 😋 😎 😍 😘 😗 😙 😚 ☺️ 🙂 🤗 🤔 😐 😑 😶 🙄 😏 😣 😥 😮 🤐 😯 😪 😫 😴 😌 😛 😜 😝 🤤 😒 😓 😔 😕 🙃 🤑 😲 ☹️ 🙁 😖 😞 😟 😤 😢 😭 👨‍👨‍👧‍👦 👨‍👨‍👦‍👦 👨‍👨‍👧‍👧 👩‍👩‍👦 👩‍👩‍👧 👩‍👩‍👧‍👦 👩‍👩‍👦‍👦 👩‍👩‍👧‍👧 👨‍👦 👨‍👦‍👦 👨‍👧 👨‍👧‍👦 👨‍👧‍👧 👩‍👦👩‍👦‍👦👩‍👧👩‍👧‍👦👩‍👧‍👧🤳💪👈👉☝️👆🖕👇✌️🤞🖖🤘🖐✋👌👍👎✊👊🤛🤜🤚👋✍️👏👐🙌🤲🙏🤝💅👂👃👣👀👁👅👄💋👶🍼",
  u8"儿勒屁艾 艾艾西艾 艾艾 西吉艾艾伊娜伊ㄚ口∪尺 れ工匚Ｋ 工れ 匚卄工れモちモ㊜㊒㊘㊕ ㊐㊋㊅㊍ ㊋㊐ ㊅㊊㊋㊐㊇㊖㊇",
  u8"б, в, г, д, ж, з, к, л, м, н, п, р, с, т, ф, х, ц, ч, ш, щ. ЯДЙDФԠ ЯЦSSЇДИ ҪҤДЯДҪГЭЯS rxtGOLmâZY くできやせろびぬぴぜ",
  u8"Νερά ψηλά λύπη αφτί ας ψυχή τι λόγω. Του φίλ διά γεφυρώνει ανίχνευση διεύρυνση. Όλο μήπως τομέα πρώτο στους δις νόημα εάν του. Παιδείας ομορφιάς καλύτερα ας με. Παραγωγή προθέαση σε κουλιζάρ παραπάνω υπ. Πώς δικούς στήθος πόντου πως θέατρο θέληση σίδερο. Σιδερένια διηγήσεων ναι δύο επέμβασης καθ ώρα ιδιαίτερα βεβαιώνει θεωρείται. Βλ νερο τη να ύλης μτφρ τέλη. Ας ρόλων τη χώρων υπ αφορά είδος είπεν. ",
  u8"למעלה מנוסה והסוס יעבור הנעשה. רגליים המכולת משונות הדרושה פנימית חודשית. את אל בגידת צד רב בתנאי ונפשו עד שש. או שב גם יד ולטש בשטף אדמת וילך הרשו וכבר. ידו העב לכל והיא ריח פוּ גַּם מַה זרמי רחץ ודה. ערך הלא זהב במבטיהם כבן בַּכֹּל הגאיוני ספק פרש קצה שנת. ",
  u8"Daje puściliśmy angielskiego służącéj Mury zostawioném sine sejm złotogłów Nogi. Białopiotrowiczowi farb dali jest kart nię. Póki śnie niewidział publicznych grzmi głos myśliwców czaty. Widzę Białopiotrowiczem panów Dozoru śrót ranną szyją. Drobnemi wyznania jedwab schowany różowe potokiem podawano wiarę schyla szepce czasem martwy. Król spokojniejszych rosciągnionych ciemnozieloném obrok kilkn wcale pokrewieństwem Musim echem niepowiedziała. Zbyt lecz noty nowe kula nóg Znam. Sama rumieńcem Zaszumiał lśnących Zbyt skórzaną młodzież nosy. Powoli Waść siadł Anglii robota twarze. ",
  u8"Плоть взята ее яд Тя ли их Одним Ни ИЗ ликом мя броня. . Воли Вы Ты тула душе Уж неба уз соты блат. Слетите отвечал богатых. Сем при глад ГРОМ дела Дуб чашу рок тел сны ров. Своих малых Приди враги. . По ты ум ﻿Кто то же ее. ",
...
private:
  ...
  TEST_METHOD(StringConversionTest_UniversalTest)
  {
    JsValueRef value;
    string str;
    for (size_t i = 0; i < SAMPLE_STR.size(); i++)
    {
      JsPointerToStringUtf8(SAMPLE_STR[i].c_str(), SAMPLE_STR[i].length(), &value);
      JsStringToStdStringUtf8(value, str);
      Assert::IsTrue(str.compare(SAMPLE_STR[i]) == 0);
    }
