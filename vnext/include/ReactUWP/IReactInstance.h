...
struct IReactInstance
{
  ...
  // Start the instance, triggering NativeModules descriptions and things to be resolved
  // spThis make caller have full ability to create the shared_ptr
  ...
  virtual const std::shared_ptr<facebook::react::MessageQueueThread>& DefaultNativeMessageQueueThread() const noexcept = 0;
