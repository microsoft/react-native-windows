...
#error The Win10 Sdk Version must be updated in code when updated in MSBuild.
      ...
      references.AddRange(new[] {
        ...
        $@"{win10SdkFolder}\References\{win10SdkVersion}\Windows.ApplicationModel.Calls.CallsPhoneContract\6.0.0.0\Windows.ApplicationModel.Calls.CallsPhoneContract.winmd",
        ...
        $@"{win10SdkFolder}\References\{win10SdkVersion}\Windows.Foundation.UniversalApiContract\14.0.0.0\Windows.Foundation.UniversalApiContract.winmd",
