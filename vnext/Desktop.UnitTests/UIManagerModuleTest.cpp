...
protected:
  ...
  std::shared_ptr<EmptyUINode> createSimpleTextHierarchy(EmptyUIManager* uiManager, std::string text)
  {
    ...
    //TODO: use managechildren instead of setchildren after it is implemented in EmptyUIManager.
...
public:
  ...
  // Tests taken from react-native\ReactAndroid\src\test\java\com\facebook\react\uimanager\UIManagerModuleTest.java
