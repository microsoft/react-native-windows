...
EmptyUIManager::EmptyUIManager(std::unique_ptr<std::vector<std::unique_ptr<IViewManager>>> viewManagers, std::shared_ptr<NodeRegistry> nodeRegistry)
...
void EmptyUIManager::createView(int64_t tag, const std::string& className, int64_t rootViewTag, folly::dynamic /*ReadableMap*/ props)
{
...
std::map<std::string, folly::dynamic> EmptyUIManagerModule::getConstants()
{
  std::map<std::string, folly::dynamic> constants{
    { "Dimensions", folly::dynamic::object
    ("windowPhysicalPixels", folly::dynamic::object
    ("width", 100)
      ("height", 100)
      ("scale", 1.0)
      ("fontScale", 1.0)
      ("densityDpi", 72))
      ("screenPhysicalPixels", folly::dynamic::object
      ("width", 100)
        ("height", 100)
        ("scale", 1.0)
        ("fontScale", 1.0)
  ...
  // TODO merge in customBubblingEventTypes and customDirectEventTypes from ViewManagers
