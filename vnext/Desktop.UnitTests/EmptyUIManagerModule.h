...
public:
  ...
  void manageChildren(int64_t viewTag, folly::dynamic* /*@Nullable ReadableArray*/ moveFrom, folly::dynamic* /*@Nullable ReadableArray*/ moveTo, folly::dynamic* /*@Nullable ReadableArray*/ addChildTags, folly::dynamic* /*@Nullable ReadableArray*/ addAtIndices, folly::dynamic* /*@Nullable ReadableArray*/ removeFrom);
  ...
  void measureLayout(int64_t tag, int64_t ancestorTag, std::function<void()> /*Callback*/ errorCallback, std::function<void()> /*Callback*/ successCallback);
  void measureLayoutRelativeToParent(int64_t tag, std::function<void()> /*Callback*/ errorCallback, std::function<void()> /*Callback*/ successCallback);
  void findSubviewIn(int64_t reactTag, folly::dynamic /*final ReadableArray*/ point, std::function<void()> /*final Callback*/ callback);
  ...
  void showPopupMenu(int64_t reactTag, folly::dynamic /*ReadableMap*/ items, std::function<void()> /*Callback*/ error, std::function<void()> /*Callback*/ success);
  void setLayoutAnimationEnabledExperimental(bool enabled);
  void configureNextLayoutAnimation(folly::dynamic /*ReadableMap*/ config, std::function<void()> /*Callback*/ success, std::function<void()> /*Callback*/ error);
