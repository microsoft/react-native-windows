...
mySimpleTurboModule.logAction(
  'getBool result',
  mySimpleTurboModule.getBool(true),
);
mySimpleTurboModule.logAction(
  'getBool result',
  mySimpleTurboModule.getBool(false),
);
mySimpleTurboModule.logAction(
  'getNumber result',
  mySimpleTurboModule.getNumber(5),
);
mySimpleTurboModule.logAction(
  'getNumber result',
  mySimpleTurboModule.getNumber(Number.NaN),
);
mySimpleTurboModule.logAction(
  'getNumber result',
  mySimpleTurboModule.getNumber(Number.POSITIVE_INFINITY),
);
mySimpleTurboModule.logAction(
  'getString result',
  mySimpleTurboModule.getString('Hello'),
);
mySimpleTurboModule.logAction(
  'getString result',
...
const obj3Matches =
  obj3.const1 === true && obj3.const2 === 375 && obj3.const3 === 'something';
mySimpleTurboModule.logAction(
  'getConstants result',
  obj3Matches ? 'OK' : 'Failed',
);

mySimpleTurboModule.getValueWithCallback(value =>
  mySimpleTurboModule.logAction('getValueWithCallback result', value),
);
...
mySimpleTurboModule
  .getValueWithPromise(/*error:*/ true)
  .catch(err =>
    mySimpleTurboModule.logAction(
      'getValueWithPromise result reject',
      err.message,
