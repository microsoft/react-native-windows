...
[Windows::UI::Xaml::Data::Bindable]
 ...
 private:
  ...
  // The title for the view shown in the list of recently used apps (by setting
  // the title on ApplicationView)
  Platform::String ^ title;

  // This class uses reference counts to make sure the secondary views isn't
  // closed prematurely. Whenever the main view is about to interact with the
  // secondary view, it should take a reference by calling "StartViewInUse" on
  // this object. When finished interacting, it should release the reference by
  // calling "StopViewInUse". You can see examples of this throughout the
  // sample, especially in scenario 1.
  int refCount;

  // Each view has a unique Id, found using the ApplicationView.Id property or
  // ApplicationView.GetApplicationViewIdForCoreWindow method. This id is used
  // in all of the ApplicationViewSwitcher and ProjectionManager APIs.
  int viewId;

  // Tracks if this ViewLifetimeControl object is still valid. If this is true,
  // then the view is in the process of closing itself down
