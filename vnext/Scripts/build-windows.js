...
if (!fs.existsSync(msbuildPath)) {
  throw new Error('Unable to find msbuild');
}
...
const utTestDll = path.resolve(
  __dirname,
  `../target/${BuildPlatform}/${BuildConfiguration}/React.Windows.Desktop.UnitTests/React.Windows.Desktop.UnitTests.dll`,
);
...
process.env.RNDesktopUTDLL = path.resolve(
  __dirname,
  `../target/${BuildPlatform}/${BuildConfiguration}/React.Windows.Desktop.IntegrationTests/React.Windows.Desktop.IntegrationTests.dll`,
);
