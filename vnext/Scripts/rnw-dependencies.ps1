...
$requirements = @(
    ...
    @{
        ...
        Install = { 
            ...
            Invoke-WebRequest https://github.com/microsoft/WinAppDriver/releases/download/v1.1/WindowsApplicationDriver.msi -UseBasicParsing -OutFile $env:TEMP\WindowsApplicationDriver.msi 
