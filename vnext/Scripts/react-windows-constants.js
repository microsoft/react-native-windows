...
let constants = {
   ...
   * @type string
   */
  vsoApiUrl: process.env.VSO_API_URL
    ? process.env.VSO_API_URL
    : 'https://office.visualstudio.com/DefaultCollection/_apis',
};

if (!constants.paToken) {
  throw new Error(
    'Personal access token must be set to VSO_AUTHTOKEN before running this script',
  );
}
