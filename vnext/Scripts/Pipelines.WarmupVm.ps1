...
if ($phase -eq '' -or $phase -eq 'prep') {
    ...
    Write-Host 'Disable virus scanning for cache and repo'
    Add-MpPreference -ExclusionPath $cacheRoot
    Add-MpPreference -ExclusionPath $agentRoot
    Add-MpPreference -ExclusionPath $warmupRoot
