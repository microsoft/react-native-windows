...
This log was last generated on Mon, 06 May 2024 15:14:30 GMT and should not be manually modified.

<!-- Start content -->

## 0.71.45

Mon, 06 May 2024 15:14:30 GMT

### Patches

- update fmt to 10.1.0 (mcota@microsoft.com)

## 0.71.44

Mon, 11 Dec 2023 16:14:12 GMT
...
Wed, 11 Oct 2023 23:26:49 GMT

### Patches

- Conditionally register WebSocket Cxx module (#12218) (julio.rocha@microsoft.com)

## 0.71.40

Fri, 06 Oct 2023 17:54:59 GMT

### Patches

- Switch between V8 JSI and V8 Node-API (vmorozov@microsoft.com)
...
- Update V8 JSI version to 0.71.8 (vmorozov@microsoft.com)
...
- Bump @react-native-windows/cli to v0.71.17

## 0.71.32

Thu, 17 Aug 2023 03:55:07 GMT

### Patches

- Re-apply cherry pick of PR #11696 with fixes (vmorozov@microsoft.com)
- Bump @react-native-windows/cli to v0.71.16

## 0.71.31

Wed, 16 Aug 2023 13:28:46 GMT

### Patches

- Add `separateDataFiles` to @rnw/cli and @rnw/codegen (53799235+ZihanChen-MSFT@users.noreply.github.com)
- Bump @react-native-windows/cli to v0.71.15
- Bump @react-native-windows/codegen to v0.71.7
...
- Bump @react-native-windows/cli to v0.71.10
- Bump @react-native-windows/codegen to v0.71.5

## 0.71.20

Wed, 21 Jun 2023 15:24:51 GMT

### Patches

- Add a checksum to the script cache (tudor.mihai@microsoft.com)
...
- Bump @react-native-windows/cli to v0.71.7
- Bump @react-native-windows/codegen to v0.71.4

## 0.71.16

Tue, 06 Jun 2023 19:20:17 GMT

### Patches

- Disable RestoreUseStaticGraphEvaluation for VS >= 17.6 (jthysell@microsoft.com)
- Bump @react-native-windows/cli to v0.71.6

## 0.71.15

Thu, 25 May 2023 15:09:11 GMT
...
Mon, 15 May 2023 15:16:30 GMT

### Patches

- Revert 10863 (34109996+chiaramooney@users.noreply.github.com)
- Backport Yoga Fix (34109996+chiaramooney@users.noreply.github.com)
...
- Revert 10863 (34109996+chiaramooney@users.noreply.github.com)
- [Image] Fix svg rendering (#11009) (email not defined)
- Promote 0.71 to latest (34109996+chiaramooney@users.noreply.github.com)
- Bump @react-native-windows/cli to v0.71.0
...
- Implement HTTP incremental updates (#10933) (jurocha@microsoft.com)
- Promote 0.71 to preview (34109996+chiaramooney@users.noreply.github.com)
- Bump @react-native-windows/cli to v0.71.0-preview.1
- Bump @react-native-windows/codegen to v0.71.0-preview.1
