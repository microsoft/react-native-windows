...
- Remove Focus Outline for Programmatical Focus (66076509+vineethkuttan@users.noreply.github.com)
...
- Turn off explicit hermes microtasks in paper (30809111+acoates-ms@users.noreply.github.com)
...
- Bump @react-native-windows/cli to v0.81.6
...
- fix Unicode length Calculation in Text Component (66076509+vineethkuttan@users.noreply.github.com)
...
- Bump release (30809111+acoates-ms@users.noreply.github.com)
...
- fix clang-diagnostic-unused-function warning (30809111+acoates-ms@users.noreply.github.com)
...
- Implement button property (hmalothu@microsoft.com)
...
Sat, 20 Dec 2025 12:02:34 GMT

### Patches

- Promote 0.81 to latest (66076509+vineethkuttan@users.noreply.github.com)
- Bump @react-native-windows/cli to v0.81.0
- Bump @react-native-windows/codegen to v0.81.0
...
- Bump @react-native-windows/cli to v0.81.0-preview.3
- Bump @react-native-windows/codegen to v0.81.0-preview.3
