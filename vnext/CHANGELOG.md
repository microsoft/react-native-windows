...
<!-- This log was last generated on Wed, 05 Aug 2026 17:19:04 GMT and should not be manually modified. -->

<!-- Start content -->

## 0.83.3

Wed, 05 Aug 2026 17:19:04 GMT

### Patches

- Fixes misalignment with TextInput on different display scales (dlucas@seabird.com)
- fix(pointer): null-check the capturing component view before notifying OnPointerCaptureLost (crash when the capturing component was unmounted) (collindanielschneide@gmail.com)
...
- Bump @react-native-windows/cli to v0.83.1
...
- Bump @react-native-windows/codegen to v0.83.0
- Bump react-native-platform-override to v0.83.0

## 0.83.0-preview.5

Fri, 15 May 2026 06:58:54 GMT
...
- unbroken linting error fix (protikbiswas@microsoft.com)
- Upgrade to Boost 1.84 (julio.rocha@microsoft.com)
- Bump @react-native-windows/cli to v0.83.0-preview.2
- Bump @react-native-windows/codegen to v0.83.0-preview.2
