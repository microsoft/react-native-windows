...
This log was last generated on Mon, 10 Apr 2023 15:09:08 GMT and should not be manually modified.

<!-- Start content -->

## 0.68.31

Mon, 10 Apr 2023 15:09:08 GMT

### Patches

- [0.68] Ensure ReactNativeWindowsDir is set in Directory.Build.props (jthysell@microsoft.com)

## 0.68.30

Tue, 21 Mar 2023 20:22:32 GMT

### Patches

- [0.68] CrashManager should also handle SIGABRT (tudor.mihai@microsoft.com)

## 0.68.29

Mon, 06 Mar 2023 16:09:29 GMT
...
Mon, 26 Dec 2022 16:09:55 GMT

### Patches

- Fix compiler issue for older versions of C++/WinRT (#10278) (julio.rocha@microsoft.com)

## 0.68.25

Mon, 19 Dec 2022 16:10:36 GMT
...
Mon, 12 Dec 2022 16:11:17 GMT

### Patches

- Implement HTTP incremental updates (#10933) (julio.rocha@microsoft.com)

## 0.68.23

Mon, 05 Dec 2022 16:10:41 GMT
...
- Bump @react-native-windows/cli to v0.68.7
...
- Bump @react-native-windows/cli to v0.68.6
...
- Add additional export for desktop x86 dll (acoates@microsoft.com)
...
- Bump @react-native-windows/cli to v0.68.3
- Bump @react-native-windows/virtualized-list to v0.68.1
- Bump @react-native-windows/codegen to v0.68.1

## 0.68.6

Mon, 20 Jun 2022 15:08:27 GMT
...
- Hermes version bump (48035227+tudorms@users.noreply.github.com)

## 0.68.4

Mon, 30 May 2022 15:08:00 GMT

### Patches

- [0.68] Change CG registration for folly and fmt from `other` to `git` (jthysell@microsoft.com)
...
- Bump @react-native-windows/cli to v0.68.1
...
- Bump @react-native-windows/cli to v0.68.0-preview.6
...
- Set ResolveNuGetPackages in external props (#9628) (julio.rocha@microsoft.com)
- Bkpt API Docs Change (34109996+chiaramooney@users.noreply.github.com)
- [0.68] Capture MSBuild properties in telemetry (jthysell@microsoft.com)
- Bump @react-native-windows/cli to v0.68.0-preview.5
...
- Bump @react-native-windows/cli to v0.68.0-preview.3
...
- Bump @react-native-windows/cli to v0.68.0-preview.2
...
- Bump @react-native-windows/cli to v0.68.0-preview.1
