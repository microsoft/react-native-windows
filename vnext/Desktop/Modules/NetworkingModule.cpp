...
IHttpResource* NetworkingModule::GetResource(int64_t requestId) noexcept
{
  ...
  if (m_resources.find(requestId) == std::end(m_resources))
  {
    ...
    rc->SetOnRequest([this, requestId]()
    {
...
void NetworkingModule::OnResponseReceived(int64_t requestId, int64_t statusCode, const dynamic& headers, const string& url) noexcept
{
...
{
  return {
    Method("sendRequest", [this](dynamic args, Callback cb) noexcept
    {
    ...
    Method("abortRequest", [this](dynamic args) noexcept
    {
