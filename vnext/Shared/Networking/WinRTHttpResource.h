...
class WinRTHttpResource : public IHttpResource,
  ...
  std::function<void(int64_t requestId, folly::dynamic &&responseData)> m_onBlobData;
...
#pragma region IHttpResource
  ...
  void SetOnBlobData(std::function<void(int64_t requestId, folly::dynamic &&responseData)> &&handler) noexcept override;
