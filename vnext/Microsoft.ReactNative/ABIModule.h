...
class ABIModule : public facebook::xplat::module::CxxModule {
 ...
 private:
  ...
  facebook::xplat::module::CxxModule::Method WrapAction(
      hstring methodName,
      Bridge::Method const &method);

  facebook::xplat::module::CxxModule::Method WrapCallback(
      hstring methodName,
      Bridge::Method const &method);

  facebook::xplat::module::CxxModule::Method WrapPromise(
      hstring methodName,
      Bridge::Method const &method);
};
