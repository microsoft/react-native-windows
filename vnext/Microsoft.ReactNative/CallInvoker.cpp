...
CallInvoker::CallInvoker(Mso::React::IReactContext &reactContext, std::shared_ptr<facebook::react::CallInvoker> callInvoker) noexcept : m_callInvoker(callInvoker), m_context(&reactContext) {}
...
winrt::Microsoft::ReactNative::CallInvoker CallInvoker::FromProperties(const winrt::Microsoft::ReactNative::ReactPropertyBag& properties) noexcept {
    return properties.Get(CallInvokerPropertyId());
}

void CallInvoker::SetProperties(const winrt::Microsoft::ReactNative::ReactPropertyBag& properties,  winrt::Microsoft::ReactNative::CallInvoker invoker) noexcept {
