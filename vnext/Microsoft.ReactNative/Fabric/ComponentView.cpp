...
namespace winrt::Microsoft::ReactNative::implementation {
  ...
  ComponentView::ComponentView(facebook::react::Tag tag,
    winrt::Microsoft::ReactNative::ReactContext const& reactContext, bool customComponent) : m_tag(tag), m_reactContext(reactContext), m_customComponent(customComponent)
  {
  }
  ...
  const winrt::Microsoft::ReactNative::IComponentProps ComponentView::userProps(facebook::react::Props::Shared const &props) noexcept {
    assert(false); // Custom components must provide an override to extract the IComponentProps from the specific Props object used by the component
    return nullptr;
  }
    ...
    facebook::react::LayoutMetrics const& oldLayoutMetrics) noexcept
  {
    // Review is it expected that I need this cast to call overridden methods?
    winrt::Microsoft::ReactNative::ComponentView outer(*this);
      outer.UpdateLayoutMetrics({ {layoutMetrics.frame.origin.x,
  ...
  winrt::Microsoft::ReactNative::Composition::implementation::RootComponentView* ComponentView::rootComponentView() noexcept
  {
    assert(false);
    return nullptr;
  }
  ...
  facebook::react::Tag
    ComponentView::hitTest(facebook::react::Point pt, facebook::react::Point& localPt, bool ignorePointerEvents) const noexcept
  {
    return -1;
  }
