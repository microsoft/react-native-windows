...
// Controls adding/removing appropriate visuals to a parent to render a specific border without requiring 
  struct BorderPrimitive
  {
    ...
    // Use when attaching to an existing visual - We do this for View's border properties, to optimize the number of visuals for each view.
    BorderPrimitive(
    ...
    void finalize(facebook::react::LayoutMetrics const &layoutMetrics, const facebook::react::BorderMetrics &borderMetrics) noexcept;
    void onThemeChanged(facebook::react::LayoutMetrics const &layoutMetrics, const facebook::react::BorderMetrics &borderMetrics) noexcept;
    ...
    static facebook::react::BorderMetrics resolveAndAlignBorderMetrics(facebook::react::LayoutMetrics const &layoutMetrics,
        const facebook::react::ViewProps &viewProps) noexcept;

    static bool requiresBorder(const facebook::react::BorderMetrics& borderMetrics, winrt::Microsoft::ReactNative::Composition::implementation::Theme* theme) noexcept;
