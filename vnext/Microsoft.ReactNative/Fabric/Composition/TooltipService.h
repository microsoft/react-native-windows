...
struct TooltipService {
    ...
    void Entered(std::shared_ptr<TooltipTracker> tracker) noexcept;
    void Exited(std::shared_ptr<TooltipTracker> tracker) noexcept;

    static std::shared_ptr<TooltipService> GetCurrent(const winrt::Microsoft::ReactNative::ReactPropertyBag &properties) noexcept;
