...
{
    winrt::ReactNative::ReactNativeHost ReactNativeWindow::CreateReactNativeHost(
        ...
        winrt::UI::Composition::Compositor const& compositor)
    {
        ...
        winrt::ReactNative::Composition::CompositionUIService::SetCompositor(
          host.InstanceSettings(),
          compositor);

        return host;
    }

    winrt::ReactNative::ReactNativeIsland ReactNativeWindow::CreateReactNativeIsland(
        winrt::UI::Composition::Compositor const& compositor,
        winrt::UI::Windowing::AppWindow const& window,
        winrt::ReactNative::ReactNativeHost const& host,
        hstring const& mainComponentName)
    {
        return winrt::make<ReactNativeIsland>(
          compositor,
          window,
          host,
          mainComponentName);
