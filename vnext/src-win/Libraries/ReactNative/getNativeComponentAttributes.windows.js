...
function getNativeComponentAttributes(uiViewClassName: string): any {
  const viewConfig = UIManager.hasViewManagerConfig(uiViewClassName); // [Windows] - Remove after #14744 is closed.
  ...
  while (baseModuleName) {
    const baseModule = UIManager.hasViewManagerConfig(baseModuleName); // [Windows] - Remove after #14744 is closed.
    if (!baseModule) {
      baseModuleName = null;
    } else {
      bubblingEventTypes = {
