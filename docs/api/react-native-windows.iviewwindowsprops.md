...
|  --- | --- | --- |
|  [acceptsKeyboardFocus](./react-native-windows.iviewwindowsprops.acceptskeyboardfocus.md) | <code>boolean</code> | Deprecated. Use [focusable](./react-native-windows.iviewwindowsprops.focusable.md) instead. |
...
|  [focusable](./react-native-windows.iviewwindowsprops.focusable.md) | <code>boolean</code> |  |
